...
- [ ] 1. Database schema and environment configuration
  - [~] 1.1 Add `role` column to user table and create `change_records` schema
  ...
  - [~] 1.2 Add GitHub environment variables to server env validation
    - Add `GITHUB_TOKEN`, `GITHUB_OWNER`, `GITHUB_REPO` as optional string fields in `packages/env/src/server.ts`
    - _Requirements: 2.1, 2.2_

- [ ] 2. MDX parser/serializer and slug validation utilities
  - [ ] 2.1 Implement `parseMdx` and `serializeMdx` in `packages/api/src/lib/mdx.ts`
  ...
  - [ ] 2.3 Implement `isValidSlug` in `packages/api/src/lib/mdx.ts`
...
- [ ] 4. GitHub Service
  - [ ] 4.1 Implement GitHub Service in `packages/api/src/lib/github.ts`
...
- [ ] 5. Content tRPC Router
  - [ ] 5.1 Create `adminProcedure` middleware and content router skeleton
  ...
  - [ ] 5.2 Implement `content.list` query
  ...
  - [ ] 5.3 Implement `content.get` query
  ...
  - [ ] 5.4 Implement `content.submit` mutation
  ...
  - [ ] 5.5 Implement `content.create` mutation
  ...
  - [ ] 5.6 Implement `content.publish` mutation
  ...
  - [ ] 5.7 Implement `content.discard` mutation
    - Close PR, delete branch, delete `change_record`
    - _Requirements: 11.4, 13.6_

  - [ ] 5.8 Implement `content.checkConflict` and `content.resolveConflict`
